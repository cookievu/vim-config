...
"   <Ctrl>g - Search current directory for occurences of given term and close window if no results
"   <Ctrl>j - Search current directory for occurences of word under cursor
